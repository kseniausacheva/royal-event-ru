  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    ru: {
      ...
      content: [
        ...
        { type: 'image', url: '/carlsberg-2.JPG', alt: 'Выступление спикера на международной конференции Carlsberg в Domina Coral Bay', caption: 'Формальное выступление на нашем кейсе Carlsberg: профессиональный продакшн, большой LED-экран, сценический свет — всё работает на воспринимаемость спикера' },
        ...
        { type: 'image', url: '/nl-18.jpg', alt: 'Церемония награждения сотрудников на корпоративе NL International', caption: 'Награждение сотрудников на гала-вечере NL International — пример церемонии с правильным таймингом и эмоциональной подачей' },
        ...
        { type: 'image', url: '/bd-4.jpg', alt: 'Банкет в формате бедуинского ужина — пример нестандартной локации', caption: 'Бедуинский ужин в пустыне — пример банкетной части в нестандартной локации. Формат, который работает для протокольных мероприятий VIP-уровня' },
        ...
        { type: 'image', url: '/nl-25.jpg', alt: 'Развлекательная программа корпоратива NL International — шоу-номер', caption: 'Шоу-программа на корпоративе NL International — высокий уровень продакшна и приглашённых артистов' },
