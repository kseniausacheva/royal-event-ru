...
export const blogArticles = [
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    image: 'https://images.unsplash.com/photo-1564585222527-c2777a5bc6cb?auto=format&fit=crop&q=80&w=1600',
    ru: {
      ...
      content: [
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?auto=format&fit=crop&q=80&w=1600', alt: 'Премиум-отель в Шарм-эль-Шейхе с бассейном и пальмами', caption: 'Премиум-отели Шарма по уровню сервиса соответствуют международным стандартам (Four Seasons, Hilton, Marriott, Kempinski), но стоят в 2–3 раза дешевле аналогичных площадок в Дубае или Лондоне' },
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1571406761758-9a3eed5338ef?auto=format&fit=crop&q=80&w=1600', alt: 'Современный курортный отель класса all-inclusive в Шарм-эль-Шейхе', caption: 'Современные all-inclusive отели в Nabq Bay — оптимальный формат для многодневных корпоративных выездов: всё включено, минимум логистики' },
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&q=80&w=1600', alt: 'Побережье Красного моря в Шарм-эль-Шейхе — идеальная локация для тимбилдинга', caption: 'Красное море с лучшими в мире коралловыми рифами — естественный плюс Шарма для тимбилдингов и активити-программ' },
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1547036967-23d11aacaee0?auto=format&fit=crop&q=80&w=1600', alt: 'Сафари в пустыне на верблюдах — типичная активность для корпоратива в Шарме', caption: 'Сафари в пустыне на верблюдах или квадроциклах + бедуинский ужин — самый запоминающийся формат тимбилдинга в Шарме' },
  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    ru: {
      ...
      content: [
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1559223607-a43c990c692c?auto=format&fit=crop&q=80&w=1600', alt: 'Выступление спикера на корпоративном мероприятии с микрофоном и аудиторией', caption: 'Грамотная подача спикера = чёткая структура + правильный микрофон + контролируемый свет. Любая из этих составляющих может убить даже сильный контент' },
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1551836022-deb4988cc6c0?auto=format&fit=crop&q=80&w=1600', alt: 'Торжественная церемония награждения с трофеями и аплодисментами', caption: 'Торжественное вручение — момент, ради которого делается всё мероприятие. Подсветка лауреата, чёткое объявление, профессиональная подача статуэтки' },
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?auto=format&fit=crop&q=80&w=1600', alt: 'Сервировка банкетного стола с бокалами и приборами для протокольного приёма', caption: 'Банкетная часть начинается ещё до прихода гостей: рассадка, сервировка, расстановка карточек с именами — всё подготовлено заранее' },
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?auto=format&fit=crop&q=80&w=1600', alt: 'Сцена с концертным светом и зрительный зал на корпоративном мероприятии', caption: 'Главное правило развлекательной части — НЕ возвращать аудиторию к формальному тону. Только развлечение, музыка и общение' },
