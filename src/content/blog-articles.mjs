  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    ru: {
      ...
      content: [
        ...
        { type: 'image', url: '/bd-1.jpg', alt: 'Бедуинский ретрит в пустыне — пример уникальной локации для executive', caption: 'VIP Бедуинский ужин в Four Seasons — формат локации, который работает и для executive-ретритов: тишина пустыни, отсутствие связи, эксклюзивность' },
...
Royal Event Group designs and runs business retreats in Egypt, UAE, Turkey, and Russia — from executive retreats for 8 people at Four Seasons to team-integration programs for 80+ participants at buyout resorts. If you're considering a retreat format for your company — talk to us at the stage of formulating goals.`,
  ...
  <text x="495" y="293" text-anchor="middle" font-family="system-ui" font-size="11" fill="#64748b">2026</text>
        ...
        { type: 'image', url: '/bd-1.jpg', alt: 'VIP Бедуинский ужин в Four Seasons — пример experiential catering от Royal Event Group', caption: 'VIP Бедуинский ужин в Four Seasons — пример experiential catering с настоящей региональной кухней. Кейс Royal Event Group в Шарм-эль-Шейхе' },
  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    ru: {
      ...
      content: [
        ...
        { type: 'image', url: '/carlsberg-0.JPG', alt: 'Флагманская конференция Carlsberg на 1000 человек', caption: 'Кейс: международная конференция Carlsberg на 1000 человек в Domina Coral Bay — пример flight to quality формата' },
        ...
        { type: 'image', url: '/ewa-14.jpg', alt: 'Experiential мероприятие EWA Product в Шарм-эль-Шейхе', caption: 'Кейс EWA Product: 5-дневный корпоративный выезд с workshop’ами, тимбилдингом и аутентичной программой — пример experience-first подхода' },
        ...
        { type: 'image', url: '/nl-7.jpg', alt: 'NL International — 7-дневный корпоративный выезд в Шарм-эль-Шейхе', caption: 'Кейс NL International — пример bleisure: 7 дней деловой программы + культурных и развлекательных активностей' },
  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    ru: {
      ...
      content: [
        ...
        { type: 'image', url: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&q=80&w=1600', alt: 'Современный кофе-брейк с healthy-перекусами и эстетичной подачей', caption: 'Современный кофе-брейк: эстетичная подача, маркировка аллергенов, функциональные продукты' },
  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    ru: {
      ...
      content: [
        ...
        { type: 'image', url: '/carlsberg-0.JPG', alt: 'Конференция Carlsberg на 1000 человек в Domina Coral Bay, Египет', caption: 'Один из наших проектов: международная конференция Carlsberg на 1000 человек в отеле Domina Coral Bay, Шарм-эль-Шейх' },
        ...
        { type: 'image', url: '/bd-1.jpg', alt: 'VIP Бедуинский ужин в Four Seasons Шарм-эль-Шейх — наш проект', caption: 'VIP Бедуинский ужин в Four Seasons — пример experiential dining, который невозможно повторить в Дубае или Лондоне' },
        ...
        { type: 'image', url: '/nl-7.jpg', alt: 'Корпоративный выезд NL International на 7 дней в Park Regency, Шарм-эль-Шейх', caption: 'Кейс NL International: 300 участников, 7 дней, бизнес-программа + инсентив-активности — формат, идеально подходящий для Египта' },
  ...
  // ───────────────────────────────────────────────────────────────────────
  {
    ...
    ru: {
      ...
      content: [
        ...
        { type: 'image', url: '/nl-7.jpg', alt: 'Корпоративный выезд NL International — пример эффективного тимбилдинга', caption: 'Кейс NL International: 300 участников, 7 дней комбинированной программы (бизнес + тимбилдинг + культурный опыт)' },
