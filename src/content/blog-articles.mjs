 ...
 *   image           — URL картинки (Unsplash или /название-файла из public/)
 ...
 *   ru.content      — полный текст. Абзацы разделяй ПУСТОЙ строкой (двойной Enter).
 *                     Строки вида "1. Заголовок" автоматически рендерятся как h3.
 *   ru.category     — категория (отображается на странице)
 *   ru.date         — человекочитаемая дата для отображения (например "15 Июня, 2026")
 *
 * @typedef {Object} BlogArticleTranslation
 ...
 * @property {BlogArticleTranslation} ru
 * @property {BlogArticleTranslation} en
 */
